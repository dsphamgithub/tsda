...
class TfExampleDecoder(object):
  ...
  def __init__(self, include_mask=False, regenerate_source_id=False):
    ...
    self._keys_to_features = {
        ...
        'image/object/damage/tl': tf.VarLenFeature(tf.float32),
        'image/object/damage/tr': tf.VarLenFeature(tf.float32),
        'image/object/damage/br': tf.VarLenFeature(tf.float32), 
        'image/object/damage/bl': tf.VarLenFeature(tf.float32)
    }
    if include_mask:
  ...
  def _decode_damages(self, parsed_tensors):
    tl = parsed_tensors['image/object/damage/tl']
    tr = parsed_tensors['image/object/damage/tr']
    br = parsed_tensors['image/object/damage/bl']
    bl = parsed_tensors['image/object/damage/br']
    return tf.stack([tl, tr, br, bl], axis=-1)
  ...
  def decode(self, serialized_example):
    ...
    damages = self._decode_damages(parsed_tensors)
