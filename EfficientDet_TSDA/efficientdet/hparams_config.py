...
def default_detection_configs():
  ...
  h.jitter_min = 0.1
  h.jitter_max = 2.0
  h.autoaugment_policy = None  # `v0`, `v1`, `v2`, `v3`, `test`, or None
  h.grid_mask = False
  h.sample_image = None
  ...
  h.num_classes = 1  # 1+ actual classes, 0 is reserved for background.
  ...
  # h.label_map = {  # This is the simplified, categorical label map for GTSDB explicitly defined
  #     0: 'signs',
  #     1: 'warning',
  #     2: 'speed_limit',
  #     3: 'regulatory',
  ...
  #     7: 'stop',
  #     8: 'priority_road'
  # }  # a dict or a string of 'coco', 'voc', 'waymo'.
  # h.label_map = {  # This is the label map for GTSDB explicitly defined
  #     0: 'signs',
  #     1: 'animals',
  #     2: 'bend_left',
  #     3: 'bend_right',
  ...
  #     7: 'give_way',
  #     8: 'go_left',
  #     9: 'go_left_or_straight',
  #     10: 'go_right',
  #     11: 'go_right_or_straight',
  #     12: 'go_straight',
  #     13: 'keep_left',
  #     14: 'keep_right',
  #     15: 'no_entry',
  #     16: 'no_overtaking',
  #     17: 'no_overtaking_trucks',
  #     18: 'no_traffic_both_ways',
  #     19: 'pedestrian_crossing',
  #     20: 'priority_at_next_intersection',
  #     21: 'priority_road',
  #     22: 'restriction_ends_80',
  #     23: 'restriction_ends_overtaking',
  #     24: 'restriction_ends_overtaking_trucks',
  #     25: 'restrictions_ends',
  #     26: 'road_narrows',
  #     27: 'roundabout',
  #     28: 'school_crossing',
  #     29: 'slippery_road',
  ...
  h.aspect_ratios = [1.0]  # [[0.7, 1.4], [1.0, 1.0], [1.4, 0.7]]
  h.anchor_scale = 1.5
  ...
  # classification loss
  h.label_smoothing = 0.1  # 0.1 is a good default
  ...
  # total loss = box_loss * box_loss_weight + iou_loss * iou_loss_weight + dmg_loss * damage_loss_weight
  h.box_loss_weight = 50.0
  h.iou_loss_type = None
  h.iou_loss_weight = 1.0
  h.damage_loss_weight = 1.0
  ...
  h.num_damage_sectors = 4  # Number of damage sectors image is divided into
  # Whether to use a seperate convolutional block to evaluate damage. Otherwise, use
  # the class prediction network's weights (adding an extra output head to ClassNet).
  h.damage_net = True
  # NOTE: Currently just using box_class_repeats for automatic scalability
  # h.damage_repeats = 4  # Number of repeats for seperate damage network
  ...
  h.use_keras_model = True  # Original value: True
  h.dataset_type = None
