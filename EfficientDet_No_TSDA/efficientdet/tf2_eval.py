...
flags.DEFINE_string('eval_dir', None, 'Location of output directory for evaluation')
FLAGS = flags.FLAGS
...
def main(_):
  ...
  with ds_strategy.scope():
    ...
    evaluator = coco_metric.EvaluationMetric(
        filename=FLAGS.val_json_file, testdev_dir=FLAGS.eval_dir, 
        label_map=label_map)
  ...
  metrics = evaluator.result()    # Save a json file OR return COCO metrics
